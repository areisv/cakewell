<?php
    ...
    class AuthwellPrivilegeFixture extends CakeTestFixture
    {
        var $name = 'AuthwellPrivilege';
        var $import = array('table' => 'authwell_privileges');
        var $useDbConfig = 'test_suite';
    }

    class AuthwellPrivilegeRecord
    {
        ...
        {
            $path = sprintf('%s.%s', $this->random_string(4), $this->random_string(6));
            $Data = array(
                'dotpath' => $path,
                'description' => sprintf('description for %s', $path)
            );
            return $Data;
        }
